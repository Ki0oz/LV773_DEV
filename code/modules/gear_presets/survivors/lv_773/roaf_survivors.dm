...
/datum/equipment_preset/survivor/roaf/load_gear(mob/living/carbon/human/new_human)
	...
	switch(random_number)
		if(1)
			...
			new_human.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/marine/veteran/royal_marine/light/roaf(new_human), WEAR_JACKET)
		if(2)
			new_human.equip_to_slot_or_del(new /obj/item/clothing/mask/neckerchief/brown(new_human.back), WEAR_IN_BACK)
			new_human.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/marine/veteran/royal_marine/light/roaf(new_human), WEAR_JACKET)
		if(3)
			new_human.equip_to_slot_or_del(new /obj/item/clothing/mask/neckerchief/brown(new_human.back), WEAR_IN_BACK)
			new_human.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/jacket/marine/rmc/service/roaf_combat_jacket(new_human), WEAR_JACKET)
	...
	new_human.equip_to_slot_or_del(new /obj/item/clothing/accessory/storage/webbing/roaf(new_human), WEAR_ACCESSORY)
	new_human.equip_to_slot_or_del(new /obj/item/storage/belt/gun/roaf_para_belt/webley_near_empty(new_human), WEAR_WAIST)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/marine/veteran/roaf_beret(new_human), WEAR_HEAD)
...
/datum/equipment_preset/survivor/iasf/paratrooper
	...
	paygrades = list(PAY_SHORT_ROAFE4 = JOB_PLAYTIME_TIER_0, PAY_SHORT_ROAFE4 = JOB_PLAYTIME_TIER_1)
	assignment = "IASF - Paratrooper"
	job_title = JOB_TWE_IASF_PARA
	skills = /datum/skills/survivor/roaf_rifleman

/datum/equipment_preset/survivor/roaf/paratrooper/load_gear(mob/living/carbon/human/new_human)
	var/obj/item/clothing/under/marine/veteran/royal_marine/roaf/uniform = new()
...
/datum/equipment_preset/survivor/roaf/engi/load_gear(mob/living/carbon/human/new_human)
	...
	switch(R)
		...
		if(2)
			uniform.roll_suit_sleeves(new_human)
	new_human.equip_to_slot_or_del(uniform, WEAR_BODY)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/under/marine/veteran/royal_marine/roaf (new_human), WEAR_BODY)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/marine/veteran/royal_marine/light/roaf(new_human), WEAR_JACKET)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/gloves/marine/veteran/royal_marine(new_human), WEAR_HANDS)
...
/datum/equipment_preset/survivor/roaf_medic
	...
	skills = /datum/skills/roaf/medic
...
/datum/equipment_preset/survivor/roaf_pilot
	name = "Survivor - ROAF - Pilot"
	assignment = "ROAF - Pilot"
	job_title = JOB_TWE_ROAF_PILOT
	minimap_icon = "roaf_pilot"
	paygrades = list(PAY_SHORT_ROAFE6 = JOB_PLAYTIME_TIER_0)
	skills = /datum/skills/roaf/pilot
...
/datum/equipment_preset/survivor/roaf/squad_leader
	...
	assignment = "ROAF - Section Leader"
	...
	skills = /datum/skills/roaf/leader
...
/datum/equipment_preset/survivor/roaf/squad_leader/load_gear(mob/living/carbon/human/new_human)
	...
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/rmc_f90(new_human), WEAR_IN_JACKET)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/rmc_f90(new_human), WEAR_IN_JACKET)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/marine/veteran/roaf_beret/tl(new_human), WEAR_HEAD)
	new_human.equip_to_slot_or_del(new /obj/item/storage/backpack/lightpack/five_slot(new_human), WEAR_BACK)
...
/datum/equipment_preset/synth/survivor/roaf_synth/load_gear(mob/living/carbon/human/new_human)
	...
	new_human.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/marine/veteran/royal_marine/light/roaf/synth(new_human), WEAR_JACKET)
...
/datum/equipment_preset/survivor/marlowe/roaf_commander/load_gear(mob/living/carbon/human/new_human)

	new_human.equip_to_slot_or_del(new /obj/item/storage/backpack/satchel/black(new_human), WEAR_BACK)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/accessory/tie/black(new_human), WEAR_ACCESSORY)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/mask/neckerchief/brown(new_human.back), WEAR_IN_BACK)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/gloves/marine/veteran/royal_marine(new_human), WEAR_HANDS)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/under/marine/officer/royal_marine/roaf(new_human), WEAR_BODY)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/jacket/marine/rmc/service/roaf_co(new_human), WEAR_JACKET)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/shoes/marine/royal_marine/knife(new_human), WEAR_FEET)
	new_human.equip_to_slot_or_del(new /obj/item/device/radio/headset/distress/roaf(new_human), WEAR_L_EAR)
	...
	new_human.equip_to_slot_or_del(new /obj/item/stack/sheet/metal/med_small_stack(new_human.back), WEAR_IN_BACK)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/head/beret/roaf_commander_cap(new_human), WEAR_HEAD)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/glasses/sunglasses/aviator(new_human), WEAR_EYES)
	new_human.equip_to_slot_or_del(new /obj/item/storage/belt/gun/roaf_para_belt/custom/full(new_human), WEAR_WAIST)
	new_human.equip_to_slot_or_del(new /obj/item/tool/crowbar/tactical(new_human), WEAR_IN_JACKET)
